...
var u = function(t,e) {
  ...
  return "number" === typeof t && (t = 0 === t ? [] : new Array(t).join().split(",").map(Number.call,Number)),this.each(function(r,o) {
    let e = document.createDocumentFragment(); u(t || {}).map(function(t,e) {
      let n = "function" === typeof i ? i.call(this,t,e,r,o) : i; return "string" === typeof n ? this.generate(n) : u(n);
    }).each(function(t) {
  ...
  o = o; let i = this; return this.nodes.reduce(function(t,e,n) {
    let r; return o ? ((r = o.call(i,e,n)) || (r = !1),"string" === typeof r && (r = u(r)),r instanceof u && (r = r.nodes)) : r = e.innerHTML,t.concat(!1 !== r ? r : []);
  },[]);
  ...
  return this.map(function(t,e) {
    let n = t.cloneNode(!0),r = this.getAll(n); return this.getAll(t).each(function(t,e) {
      for (let n in this.mirror) this.mirror[n] && this.mirror[n](t,r.nodes[e]);
    }),n;
  });
  ...
  let t = this.slice(arguments).map(function(e) {
  ...
  if ("string" === typeof e) {
    let o = e; e = function(e) {
      let n = arguments; u(e.currentTarget).find(o).each(function(t) {
  ...
  let n = []; return this.adjacent(t,e,function(t,e) {
  ...
  let r = this; return this.slice(this.first().elements).reduce(function(e,n) {
  ...
  let o = this.slice(arguments).slice(1); return this.eacharg(t,function(t,e) {
    let n,r = {bubbles:!0,cancelable:!0,detail:o}; try {
  ...
  return this.map(function(e) {
    return u(t).each(function(t) {
      (function(t) {
        for (;t.firstElementChild;)t = t.firstElementChild; return u(t);
